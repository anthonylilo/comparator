      ...
      <Carousel.Item>
        <div className="carousel-home d-flex justify-content-center align-items-center">
          <h3 className="home-header">
            Welcome to <strong className="text-p-2">Nestlé Sync Box</strong>🤩
          </h3>
          ...
          <p>
            <strong className="text-p-2">Choose which tool</strong> you would
            like to use for the project.
          </p>
        </div>
      </Carousel.Item>
      <Carousel.Item>
        <div className="carousel-home d-flex justify-content-center align-items-left">
          ...
          <p>
            Click on<strong className="text-p-2"> Matrix Mirror</strong> in the
            tools panel to the right, then select the brand project to get
            started.
          </p>
        </div>
      </Carousel.Item>
